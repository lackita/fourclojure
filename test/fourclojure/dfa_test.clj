(ns fourclojure.dfa-test
  (:require [clojure.test :refer :all]
            [fourclojure.dfa :refer :all]))

;; (deftest full-function-test
;;   (is (= #{"a"}
;;          (set ((full-function) '{:states #{q0 q1}
;;                                  :alphabet #{a}
;;                                  :start q0
;;                                  :accepts #{q1}
;;                                  :transitions {q0 {a q1}}}))))
...
;;                                  :transitions {q0 {b q1}}}))))
;;   (is (= #{"ab"}
;;          (set ((full-function) '{:states #{q0 q1 q2}
;;                                  :alphabet #{a b}
;;                                  :start q0
;;                                  :accepts #{q2}
;;                                  :transitions {q0 {a q1}
...
;;                                                q1 {b q2}}}))))
;;   (is (= #{"a" "ab" "abc"}
;;          (set ((full-function) '{:states #{q0 q1 q2 q3}
;;                                  :alphabet #{a b c}
;;                                  :start q0
;;                                  :accepts #{q1 q2 q3}
;;                                  :transitions {q0 {a q1}
...
;;                                                q2 {c q3}}}))))
;;   (is (= #{"hi" "hey" "hello"}
;;          (set ((full-function) '{:states #{q0 q1 q2 q3 q4 q5 q6 q7}
...
;;          (set ((full-function) '{:states #{q0 q1 q2 q3 q4}
;;                                  :alphabet #{v w x y z}
;;                                  :start q0
;;                                  :accepts #{q4}
...
;;   (is (let [res (take 2000 ((full-function) '{:states #{q0 q1}
;;                                               :alphabet #{0 1}
;;                                               :start q0
;;                                               :accepts #{q0}
